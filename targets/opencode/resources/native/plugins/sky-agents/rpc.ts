...
export const SkyAgents = { id: "skynex.sky-agents", events: {}, methods: {
  ...
  saveProfile: method(input({ profile }, ["profile"]), undefined), updateProfile: method(input({ profile }, ["profile"]), undefined), deleteProfile: method(input({ name }, ["name"]), undefined),
